        ...
        messages: [
            {
                ...
                content: `Elabore, em brasileiro, uma pergunta de múltipla escolha no estilo "Show do Milhão", com nível de dificuldade fácil ou médio relacionada ao tema "${randomTheme}". As perguntas serão para um jogo a ser jogado em família, com pessoas de todas as idades. A pergunta deve ser simples, objetiva e clara, deve ter opções de resposta diretas e curtas, mas as respostas não devem ser tão óbvias, cada texto da opcao da resposta deve ter no maximo 3 palavras. As respostas devem ser fáceis de entender e relacionadas corretamente a pergunta e ao tema. Certifique-se de que a pergunta tenha a opção correta e que as respostas sejam simples e diretas. A resposta deve ser no formato: {question: '...', options: ['opção 0', 'opção 1', 'opção 2'], correct: 0}. Eu quero apenas o que está dentro de {} e não quero nada além disso.`
            },
        ],
